    ...
    <Shell actor={actor} current="/cabinet/manage/tools">
      ...
      <Card style={{ marginBottom: 24 }}>
        ...
        <Text muted size={13} style={{ marginTop: 10 }}>
          Материал, изъятый в кабинете или удалённый по требованию субъекта, убирается из папки
          зеркала ближайшим прогоном. Удалённое диск кладёт в свою Корзину, и копия лежит там до
          её очистки: после требования субъекта об удалении очистите Корзину в самом диске.
        </Text>
      </Card>
