...
/* НОРМАТИВНАЯ БАЗА. Проверено 10 августа 2026.
 ...
 РЕДАКЦИЯ 1.1 от 30.08.2026. Раздел о согласии на рекламные сообщения убран:
 отметки, которую он описывал, в формах сайта нет, а документ, описывающий
 несуществующее поле, опровергается первым же снимком страницы. Восстанавливать
 раздел следует одновременно с появлением отметки в формах.
 ...
 { href:'#version', num:'9.', title:'Дата редакции и версия' }
 ]),
