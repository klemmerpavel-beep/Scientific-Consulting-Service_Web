...
.x4:hover{color:#14161C !important;border-left-color:#14417A !important}
.x5:hover{color:#14417A !important}
`;
  ...
  render() {
    ...
    return (
      <>
        ...
        <div style={{ position: "relative", background: "#FFFFFF", color: "#14161C", fontFamily: "'Inter','Helvetica Neue',Arial,sans-serif", WebkitFontSmoothing: "antialiased" }}><a className="pd-skip" href="#main">Перейти к тексту документа</a><header className="doc-head doc-pad" style={{ maxWidth: "1220px", margin: "0 auto", padding: "24px 30px 0", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "24px", flexWrap: "wrap" }}><a className="x1" href="/" aria-label="ProDisser — на главную" style={{ display: "inline-flex", alignItems: "center", minHeight: "44px", padding: "6px 10px", margin: "-6px -10px", borderRadius: "10px", fontFamily: "'Literata',Georgia,'Times New Roman',serif", fontSize: "27px", lineHeight: "1.24", fontWeight: "600", letterSpacing: ".005em", transition: "background 180ms cubic-bezier(.2,0,.2,1)" }}><span style={{ color: "#14417A" }}>PRO</span><span style={{ color: "#14161C" }}>DISSER</span></a><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "12px", lineHeight: "1.4", letterSpacing: ".06em", textTransform: "uppercase", color: "#5C6474" }}>Проект документа</span></header><div className="doc-pad" role="region" aria-labelledby="doc-title" style={{ maxWidth: "1220px", margin: "0 auto", padding: "40px 30px 0" }}><h1 id="doc-title" style={{ margin: "0", fontFamily: "'Literata',Georgia,'Times New Roman',serif", fontSize: "28px", lineHeight: "1.24", fontWeight: "500", letterSpacing: "-.015em", color: "#14161C", maxWidth: "26ch" }}>Согласие на обработку персональных данных</h1><p className="doc-print" style={{ margin: "8px 0 0", fontSize: "13px", lineHeight: "1.5", color: "#14161C" }}>Оператор: ООО «РУСДРОН», ОГРН 1257700248860, ИНН 9723254250. Коммерческое обозначение — ProDisser.</p></div><div className="doc-layout doc-pad" style={{ maxWidth: "1220px", margin: "32px auto 0", padding: "0 30px" }}><nav className="doc-toc" aria-label="Оглавление документа"><button className="doc-toc-btn x2 x3" type="button" onClick={toggleToc} aria-expanded={tocExpanded} aria-controls="toc-list" style={{ appearance: "none", cursor: "pointer", width: "100%", alignItems: "center", justifyContent: "space-between", gap: "16px", border: "1px solid #E3E7EC", background: "#FFFFFF", borderRadius: "10px", padding: "14px 18px", fontFamily: "'Inter','Helvetica Neue',Arial,sans-serif", fontSize: "14px", fontWeight: "600", color: "#14161C", marginBottom: "12px", transition: "border-color 180ms cubic-bezier(.2,0,.2,1),opacity 180ms cubic-bezier(.2,0,.2,1)" }}>Оглавление<span aria-hidden="true" style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "12px", color: "#14417A" }}>{tocMark}</span></button><ol className="doc-toc-list" id="toc-list" hidden={tocHidden} style={{ margin: "0", padding: "0", listStyle: "none", gap: "2px", borderLeft: "1px solid #E3E7EC" }}>{(toc ?? []).map((t: any, _i0: number) => (<React.Fragment key={_i0}><li><a className="x4" href={t.href} style={{ display: "flex", alignItems: "center", minHeight: "44px", gap: "10px", padding: "7px 14px", fontSize: "14px", lineHeight: "1.4", color: "#3D4450", borderLeft: "2px solid transparent", marginLeft: "-1px", transition: "color 180ms cubic-bezier(.2,0,.2,1)" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "12px", color: "#5C6474", paddingTop: "2px", flex: "0 0 auto" }}>{t.num}</span><span>{t.title}</span></a></li></React.Fragment>))}</ol></nav><main id="main" style={{ minWidth: "0", maxWidth: "72ch" }}><p style={{ margin: "0 0 28px", fontSize: "16px", lineHeight: "1.6", color: "#3D4450" }}>Настоящий текст является формой согласия, которую субъект персональных данных принимает проставлением отметки в форме на Сайте. Согласие на обработку персональных данных и согласие на получение рекламных сообщений даются отдельно и отзываются независимо друг от друга.</p>{(sections ?? []).map((s: any, _i0: number) => (<React.Fragment key={_i0}><section id={s.id} style={{ scrollMarginTop: "24px", paddingBottom: "32px" }}><h2 style={{ margin: "0 0 14px", fontFamily: "'Literata',Georgia,'Times New Roman',serif", fontSize: "19px", lineHeight: "1.4", fontWeight: "600", letterSpacing: "-.01em", color: "#14161C", display: "flex", gap: "12px" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "14px", color: "#14417A", flex: "0 0 auto", paddingTop: "2px" }}>{s.num}</span><span>{s.title}</span></h2>{(s.items ?? []).map((p: any, _i1: number) => (<React.Fragment key={_i1}><p style={{ margin: "0 0 10px", display: "flex", gap: "12px", fontSize: "16px", lineHeight: "1.6", color: "#14161C" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "13px", color: "#5C6474", flex: "0 0 auto", paddingTop: "2px", fontVariantNumeric: "tabular-nums" }}>{p.num}</span><span>{p.text}</span></p></React.Fragment>))}</section></React.Fragment>))}<section id="ads" style={{ scrollMarginTop: "24px", border: "1px solid #D8E4F3", borderRadius: "14px", padding: "24px 26px", background: "#F6F7F9", marginBottom: "32px" }}><span style={{ display: "block", fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "12px", lineHeight: "1.4", letterSpacing: ".06em", textTransform: "uppercase", color: "#14417A", marginBottom: "12px" }}>Отдельное согласие · даётся отдельной отметкой</span><h2 style={{ margin: "0 0 14px", fontFamily: "'Literata',Georgia,'Times New Roman',serif", fontSize: "19px", lineHeight: "1.4", fontWeight: "600", letterSpacing: "-.01em", color: "#14161C", display: "flex", gap: "12px" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "14px", color: "#14417A", flex: "0 0 auto", paddingTop: "2px" }}>9.</span><span>Согласие на получение рекламных и информационных сообщений</span></h2>{(ads ?? []).map((p: any, _i0: number) => (<React.Fragment key={_i0}><p style={{ margin: "0 0 10px", display: "flex", gap: "12px", fontSize: "16px", lineHeight: "1.6", color: "#14161C" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "13px", color: "#5C6474", flex: "0 0 auto", paddingTop: "2px", fontVariantNumeric: "tabular-nums" }}>{p.num}</span><span>{p.text}</span></p></React.Fragment>))}</section><section id="version" style={{ scrollMarginTop: "24px", paddingBottom: "32px" }}><h2 style={{ margin: "0 0 14px", fontFamily: "'Literata',Georgia,'Times New Roman',serif", fontSize: "19px", lineHeight: "1.4", fontWeight: "600", letterSpacing: "-.01em", color: "#14161C", display: "flex", gap: "12px" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "14px", color: "#14417A", flex: "0 0 auto", paddingTop: "2px" }}>10.</span><span>Дата редакции и версия</span></h2><p style={{ margin: "0 0 10px", display: "flex", gap: "12px", fontSize: "16px", lineHeight: "1.6", color: "#14161C" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "13px", color: "#5C6474", flex: "0 0 auto", paddingTop: "2px" }}>10.1</span><span>Редакция от 21 августа 2026 года, версия 1.0. Действует с даты размещения на Сайте.</span></p><p style={{ margin: "0 0 10px", display: "flex", gap: "12px", fontSize: "16px", lineHeight: "1.6", color: "#14161C" }}><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "13px", color: "#5C6474", flex: "0 0 auto", paddingTop: "2px" }}>10.2</span><span>Оператор сохраняет сведения о редакции согласия, действовавшей на момент его предоставления субъектом.</span></p></section></main></div><footer className="doc-foot doc-pad" style={{ maxWidth: "1220px", margin: "32px auto 0", padding: "0 30px 40px" }}><div style={{ borderTop: "1px solid #E3E7EC", paddingTop: "24px", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "24px", flexWrap: "wrap" }}><div style={{ display: "flex", flexDirection: "column", gap: "6px", maxWidth: "60ch", fontSize: "13px", lineHeight: "1.6", color: "#5C6474" }}><span style={{ color: "#14161C" }}>ООО «РУСДРОН» · коммерческое обозначение ProDisser</span><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "12px", lineHeight: "1.5", letterSpacing: ".02em" }}>ОГРН 1257700248860 · ИНН 9723254250 · КПП 772301001</span><span style={{ fontFamily: "'JetBrains Mono','SFMono-Regular',monospace", fontSize: "12px", lineHeight: "1.5", letterSpacing: ".02em" }}>109451, г. Москва, вн. тер. г. муниципальный округ Марьино, б-р Перервинский, д. 27, к. 1, помещ. 10н</span></div><div style={{ display: "flex", flexDirection: "column", gap: "8px", fontSize: "14px", lineHeight: "1.4" }}><a className="x5" href="/offer" style={{ display: "inline-flex", alignItems: "center", minHeight: "44px", color: "#3D4450", transition: "color 180ms cubic-bezier(.2,0,.2,1)" }}>Публичная оферта</a><a className="x5" href="/privacy" style={{ display: "inline-flex", alignItems: "center", minHeight: "44px", color: "#3D4450", transition: "color 180ms cubic-bezier(.2,0,.2,1)" }}>Политика обработки персональных данных</a><a className="x5" href="/" style={{ display: "inline-flex", alignItems: "center", minHeight: "44px", color: "#3D4450", transition: "color 180ms cubic-bezier(.2,0,.2,1)" }}>На главную</a></div></div></footer></div>
      </>
    );
  }
}
