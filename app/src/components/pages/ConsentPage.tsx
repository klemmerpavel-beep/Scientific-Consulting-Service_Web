...
@media (max-width:480px){.doc-pad{padding-left:20px;padding-right:20px}}
...
.x1:hover{background:rgba(198,202,246,.3)}
.x2:hover{color:#16121C;border-left-color:#7B2BE0}
.x3:hover{color:#7B2BE0}
`;
