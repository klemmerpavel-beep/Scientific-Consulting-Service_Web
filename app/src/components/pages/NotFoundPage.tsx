...
'use client';
// Сгенерировано из NotFoundPage.dc.html через tools/dc-to-tsx.mjs.
...
.x2:hover{color:var(--pd-accent-press) !important}
.x3:hover{background:var(--pd-button-hover) !important}
.x4:hover{border-color:var(--pd-accent) !important;background:var(--pd-accent-tint) !important}
