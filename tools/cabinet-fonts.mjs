 ...
 * правила переписываются на него. Берутся только нужные кабинету
 * подмножества — основная латиница, расширенная латиница (в ней знак
 * рубля) и кириллица; греческий, вьетнамский и расширенная кириллица
 * отбрасываются. Имя файла — начало его свёртки: одинаковые байты дают
 * одинаковое имя, и повторный снимок совпадает с прежним побайтно.
 */
